        ...
        public static async Task InitializeAsync(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager)
        {
            ...
            if (!await userManager.Users.AnyAsync(x => x.UserName == Constants.DEFAULT_EMAIL))
            {
                var user = new ApplicationUser()
                {
                    ...
                    Notes = new List<Note>()
                    {
                        new Note() { Title = "Samle Note 1", Content = "Lorem ipsum dolor sit amet, consectatur adipiscing elit."},
                        new Note() { Title = "Samle Note 2", Content = "Lorem ipsum dolor sit amet, consectatur adipiscing elit."}
                    }
                };
